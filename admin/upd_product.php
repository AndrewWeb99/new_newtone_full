        ...
        <div class="main-content">
            <div class="category_list">
                ...
                <div class="form" style="width: 50%;">
                    <form action="/admin/vendor/upd_product.php" method="POST" enctype="multipart/form-data">
                        <label for="">Название</label>
                        <input name="title" type="text" value="<?= $prod['title']; ?>" /><br>
                        <label for="">Текущее изображение</label><br><br>
                        <img src="/img/product/<?= $prod['img']; ?>" alt="" width="300px"><br><br>
                        ...
                        <input name="price" type="text" value="<?= $prod['price']; ?>" /><br>
                        ...
                        <div class="select" style="margin-bottom: 40px">
                            <select name="category_id" id="">
                                ...
                                if (count($cat) > 0) {
                                    ...
                                    foreach ($cat as $c) {
                                ?>
                                        <option <? if ($c['id'] == $prod['category_id']) {
                                            echo 'selected';
                        ...
                        ?>
                            <input type="text" id="razm<?= $in; ?>" name="razm[]" class="inp_to_del" data-inp="razm<?= $in; ?>" style="margin-top: 13px; margin-bottom: 13px;" value="<?= $array[$i]; ?>">
                            <a class="c-button delete" data-elem="razm<?= $in; ?>" id="del<?= $in; ?>" style="background-color: red; text-decoration: none;">Удалить</a>
                        ...
                        <textarea name="description" id="" cols="30" rows="10"><?= $prod['description']; ?></textarea><br>
                        <label for="">Материал</label>
                        <input name="material" type="text" value="<?= $prod['material']; ?>" /><br>
                        <label for="">Страна</label>
                        <input name="country" type="text" value="<?= $prod['country']; ?>" /><br>
                        <input name="id" type="hidden" value="<?= $prod['id']; ?>" /><br>
                        <input name="old_img" type="hidden" value="<?= $prod['img']; ?>" /><br>
