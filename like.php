...
if (isset($_SESSION['user'])) {
  ...
  $basket = getLike("WHERE user_id =" . $user);
} else {
            ...
            ?>
                  <div class="basket_item">
                    ...
                    <div class="basket_item_text">
                      ...
                      <br />
                      <a href="/vendor/del_like.php?id=<?= $b['id']?>" class="c-button" style="text-decoration: none">Удалить</a><br /><br />
                    </div>
                  </div>
            <?
                }
             ...
             echo '<div style="width: 100%; text-align:center; font-size: 25px; color: black;">Нет товара в избранном</div>';
            }
